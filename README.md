...
当前版本：`1.2.0`　许可证：[MIT](LICENSE)　已验证环境：Windows、PowerShell、Codex
...
5. 每轮返工先保留回退版，再写清允许改什么、禁止改什么。
6. Gate 3 不只打勾。资产、字幕位置、保护区和锁定指纹都要有可核验记录。
...
两条案例的逐图说明见 [examples/README.md](examples/README.md)。截图均来自已经发布并通过最终审核的编码母版，没有使用概念图替代成片。
